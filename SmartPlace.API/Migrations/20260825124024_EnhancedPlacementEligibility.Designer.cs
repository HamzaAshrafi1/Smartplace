...
namespace SmartPlace.API.Migrations
{
    ...
    [Migration("20260825124024_EnhancedPlacementEligibility")]
    partial class EnhancedPlacementEligibility
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SmartPlace.API.Models.Company", b =>
                {
                    ...
                    b.HasIndex("RecruiterUserId")
                        .IsUnique()
                        .HasFilter("[RecruiterUserId] IS NOT NULL");
            ...
            modelBuilder.Entity("SmartPlace.API.Models.Job", b =>
                {
                    ...
                    b.Property<decimal>("MinimumTenthPercentage")
                        .HasPrecision(5, 2)
                        .HasColumnType("decimal(5,2)");

                    b.Property<decimal>("MinimumTwelfthPercentage")
                        .HasPrecision(5, 2)
                        .HasColumnType("decimal(5,2)");
            ...
            modelBuilder.Entity("SmartPlace.API.Models.Company", b =>
                {
                    b.HasOne("SmartPlace.API.Models.ApplicationUser", "RecruiterUser")
                        .WithOne("Company")
                        .HasForeignKey("SmartPlace.API.Models.Company", "RecruiterUserId")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("SmartPlace.API.Models.Job", b =>
                {
                    ...
                    b.HasOne("SmartPlace.API.Models.Department", "RequiredDepartment")
                        .WithMany()
